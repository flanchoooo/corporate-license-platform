<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @auth
                        @if(Auth::user()->isSuperAdmin())
                            <x-nav-link :href="route('admin.corporates.index')" :active="request()->routeIs('admin.corporates.*')">
                                {{ __('Corporates') }}
                            </x-nav-link>
                            ...
                            <x-nav-link :href="route('admin.credit-applications.index')" :active="request()->routeIs('admin.credit-applications.*')">
                                {{ __('Credit') }}
                            </x-nav-link>
                            <x-nav-link :href="route('admin.delivery-orders.index')" :active="request()->routeIs('admin.delivery-orders.*')">
                                {{ __('Deliveries') }}
                            </x-nav-link>
                        ...
                        <x-nav-link :href="route('license-disks.index')" :active="request()->routeIs('license-disks.*')">
                            {{ __('Disks') }}
                        </x-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @if(Auth::user()->isSuperAdmin())
                <x-responsive-nav-link :href="route('admin.corporates.index')" :active="request()->routeIs('admin.corporates.*')">
                    {{ __('Corporates') }}
                </x-responsive-nav-link>
                ...
                <x-responsive-nav-link :href="route('admin.credit-applications.index')" :active="request()->routeIs('admin.credit-applications.*')">
                    {{ __('Credit') }}
                </x-responsive-nav-link>
                <x-responsive-nav-link :href="route('admin.delivery-orders.index')" :active="request()->routeIs('admin.delivery-orders.*')">
                    {{ __('Deliveries') }}
                </x-responsive-nav-link>
            ...
            <x-responsive-nav-link :href="route('license-disks.index')" :active="request()->routeIs('license-disks.*')">
                {{ __('Disks') }}
            </x-responsive-nav-link>
